...
/**
 * NUEVO CartController usando el paquete Laravel Gateway
 *
 ...
 */
class CartControllerRefactored extends Controller
{
    ...
    public function show(Order $pedido)
    {
        ...
        // Usar el nuevo paquete Laravel Gateway en lugar de RedsysAPI
        ...
        return view('frontend.pagar-pedido', [
            'data' => $payment,
