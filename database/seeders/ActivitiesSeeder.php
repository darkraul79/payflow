...
class ActivitiesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Activity::factory()
            ->imagen(public_path('storage/cartel-carrera-solidaria.jpg'))
            ->create([
                'title' => $titulo,
                'slug' => Str::slug($titulo),
        ...
        Activity::factory()
            ->donacion()
            ->imagen(public_path('storage/LAS-ROZAS-FET-2025-316SALIDAS-PRUEBAS-DE-4-Y-8-KM.jpg'))->create([
                'title' => $titulo,
                'slug' => Str::slug($titulo),
