...
class PagesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $actividades = Page::factory()->create([
            'title' => 'Actividades',
            'slug' => 'actividades',
            'parent_id' => $quehacemos->id,
            'blocks' => json_decode('[{"type":"calendario","data":{"subtitle":"Ocio solidario","title":"Actividades","text":"<h2>Muy pronto te informaremos de nuestras actividades, no pierdas de vista nuestras redes sociales.<\/h2><p><br>Organizamos, promocionamos y participamos en eventos deportivos, culturales y solidarios para que colabores con nosotros, mientras disfrutas de tu tiempo de ocio.<\/p><p><br><\/p>"}},{"type":"actividades-paginadas","data":{"alignment":null,"subtitle":"Actividades","title":"Nuestras actividades","text":null,"type":"Activity","number":"9","filter":"all","activities_id":[]}}]'),
        ]);
        ...
        $tienda = Page::factory()
            ...
            ->create([
                ...
                'slug' => 'tienda-solidaria',
                'blocks' => json_decode('[{"type":"actividades-paginadas","data":{"alignment":"text-left","subtitle":"Por cada compra una sonrisa","title":"Tienda solidaria","text":null,"type":"Product","number":"12","filter":"all","activities_id":[]}}]'
                )]);

        $actualidad = Page::factory()->create([
            'title' => 'Actualidad',
            'slug' => 'actualidad',
            'parent_id' => null,
        ]);

        $noticias = Page::factory()->create([
            'title' => 'Noticias',
            'slug' => 'noticias',
            'parent_id' => $actualidad->id,
            'blocks' => json_decode('[{"type":"actividades-paginadas","data":{"alignment":null,"subtitle":"Noticias","title":"Noticias destacadas de la fundaci\u00f3n.","text":null,"type":"News","number":"3","filter":"all","activities_id":[]}}]'),
        ]);

        $proyectos = Page::factory()->create([
            'title' => 'Proyectos',
            'slug' => 'proyectos',
            'parent_id' => $actualidad->id,
            'blocks' => json_decode('[{"type":"actividades-paginadas","data":{"alignment":null,"subtitle":"Proyectos","title":"Proyectos de actualidad","text":null,"type":"Proyect","number":"9","filter":"all","activities_id":[]}}]'),
        ]);

        $menuPrincipal = Menu::find(1);

        $mQuienes = MenuItem::create([
            'menu_id' => $menuPrincipal->id,
            'parent_id' => null,
            'linkable_type' => 'App\Models\Page',
            'linkable_id' => $quienes->id,
            'title' => 'Quienes somos',
            'url' => null,
            'target' => '_self',
            'order' => 1,
        ]);
        $mQuehacemos = MenuItem::create([
            'menu_id' => $menuPrincipal->id,
            'parent_id' => null,
            'linkable_type' => 'App\Models\Page',
            'linkable_id' => $quehacemos->id,
            'title' => $quehacemos->title,
            'url' => null,
            'target' => '_self',
            'order' => 2,
        ]);
        $mTtienda = MenuItem::create([
            'menu_id' => $menuPrincipal->id,
            'parent_id' => null,
            'linkable_type' => 'App\Models\Page',
            'linkable_id' => $tienda->id,
            'title' => $tienda->title,
            'url' => null,
            'target' => '_self',
            'order' => 3,
        ]);
        $mActualidad = MenuItem::create([
            'menu_id' => $menuPrincipal->id,
            'parent_id' => null,
            'linkable_type' => 'App\Models\Page',
            'linkable_id' => $actualidad->id,
        ...
        MenuItem::create([
            'menu_id' => $menuPrincipal->id,
            'parent_id' => $mQuienes->id,
            'linkable_type' => 'App\Models\Page',
            'linkable_id' => $fundacion->id,
        ...
        MenuItem::create([
            'menu_id' => $menuPrincipal->id,
            'parent_id' => $mQuehacemos->id,
            'linkable_type' => 'App\Models\Page',
            'linkable_id' => $osteosarcoma->id,
        ...
        MenuItem::create([
            'menu_id' => $menuPrincipal->id,
            'parent_id' => $mActualidad->id,
            'linkable_type' => 'App\Models\Page',
            'linkable_id' => $actividades->id,
        ...
        $menuFooter1 = Menu::find(2);
        MenuItem::create([
            'menu_id' => $menuFooter1->id,
            'parent_id' => null,
            'linkable_type' => 'App\Models\Page',
            'linkable_id' => $home->id,
            'title' => $home->title,
        ...
        $menuFooter2 = Menu::find(3);
        MenuItem::create([
            'menu_id' => $menuFooter2->id,
            'parent_id' => null,
            'linkable_type' => 'App\Models\Page',
            'linkable_id' => $transparencia->id,
            'title' => $transparencia->title,
