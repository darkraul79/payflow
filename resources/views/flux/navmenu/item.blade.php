...
@php
    ...
    $classes = Flux::classes()
        ...
        ->add('rounded-md')
        ->add('text-start text-sm font-light')
        ->add(
            match ($variant) {
                'danger' => [
                    'text-azul-sea hover:text-red-600 hover:bg-red-50  ',
                    '**:data-navmenu-icon:text-zinc-400  [&:hover_[data-navmenu-icon]]:text-current',
                ],
                'default' => ['text-azul-sea hover:font-semibold ', '**:data-navmenu-icon:text-zinc-400  [&:hover_[data-navmenu-icon]]:text-current'],
            },
        )
