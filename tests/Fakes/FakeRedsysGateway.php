...
class FakeRedsysGateway extends RedsysGateway
{
    ...
    {
        // Intentar llamar al constructor padre, pero capturar excepciones si faltan credenciales
        try {
            parent::__construct();
        } catch (RuntimeException) {
            // Si el constructor padre lanza RuntimeException por falta de credenciales,
            // inicializar manualmente las propiedades protegidas con valores de test
    ...
    public function sendRestPayment(): array
    {
        ...
        // Obtener el identifier si existe en los parámetros
        $identifier = $this->parameters['DS_MERCHANT_IDENTIFIER'] ?? null;
        ...
        // Incluir el identifier en la respuesta si existe (pagos recurrentes)
        if ($identifier) {
            $decoded['Ds_Merchant_Identifier'] = $identifier;
        }
